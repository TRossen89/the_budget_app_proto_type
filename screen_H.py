...
#---SAVING SCREEN_H AS LAST ENTERED SCREEN SO IF APP IS CLOSED WHILE SCREEN_H IS SHOWED,
#---SCREEN_H WILL SHOW NEXT TIME APP IS OPENED--------

    def screen_H_in_last_entered_screen_json_file (self):
